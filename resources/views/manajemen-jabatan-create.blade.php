...
<head>
    ...
    <title>Tambah Jabatan - SIKAP</title>
...
<body class="bg-[#E8F5F2] font-sans antialiased flex h-screen overflow-hidden text-gray-800">
    ...
    <main class="flex-1 p-10 lg:p-12 overflow-y-auto">
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-[2rem] font-black text-[#1A634E] mb-1">Tambah Jabatan Pegawai</h1>
                <p class="text-gray-500 font-semibold text-[14px]">Tetapkan Jabatan dan Unit Kerja ke pegawai yang sudah ada.</p>
            </div>
            <a href="/manajemen-jabatan" class="text-[#329E80] font-bold hover:underline flex items-center gap-2">
                <i class="fa-solid fa-arrow-left"></i> Kembali
            </a>
        </div>

        <div class="bg-white rounded-[2rem] p-10 shadow-sm border border-gray-100 max-w-3xl">
            <form action="/manajemen-jabatan/tambah" method="POST" class="space-y-6">
                @csrf
                
                <div>
                    <label class="block text-sm font-bold text-[#1D6751] mb-2">Pilih Pegawai (Nama - NIP)</label>
                    <select name="user_id" required class="w-full px-4 py-3 bg-[#F4F7F6] border border-gray-200 rounded-xl font-bold text-[#1A634E] focus:ring-2 focus:ring-[#329E80] focus:outline-none transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-bold text-[#1D6751] mb-2">Unit Kerja</label>
                        <input type="text" name="unit_kerja" required placeholder="Contoh: Tata Usaha" class="w-full px-4 py-3 bg-[#F4F7F6] border border-gray-200 rounded-xl font-medium focus:ring-2 focus:ring-[#329E80] focus:outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-[#1D6751] mb-2">Nama Jabatan</label>
                        <input type="text" name="jabatan" required placeholder="Contoh: Staf Keuangan" class="w-full px-4 py-3 bg-[#F4F7F6] border border-gray-200 rounded-xl font-medium focus:ring-2 focus:ring-[#329E80] focus:outline-none transition-all">
                    </div>
                </div>
                ...
                <div class="pt-6">
                    <button type="submit" class="w-full bg-[#1A634E] hover:bg-[#114032] transition-colors text-white px-6 py-4 rounded-xl font-bold shadow-lg flex justify-center items-center gap-2">
                        <i class="fa-solid fa-floppy-disk"></i> Simpan Penugasan Jabatan
                    </button>
                </div>
            </form>
        </div>
