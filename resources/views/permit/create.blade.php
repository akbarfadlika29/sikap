...
@section('subtitle', 'Tambahkan data izin aktivitas luar pegawai dan pejabat.')
        ...
        <div class="permit-form-header">
            ...
            <div class="permit-form-header-inner">
                ...
                <div>
                    ...
                    <p>
                        Lengkapi informasi aktivitas luar pegawai.
                    </p>
                                ...
                                >
                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <option
                                            ...
                                            {{ $sedangDiLuar ? 'disabled' : '' }}
                                        >
                                            {{ $user->nama }} — {{ $user->nip }}
                                            {{ $sedangDiLuar ? ' - Sedang di Luar' : '' }}
                                        </option>
                ...
                <div class="permit-section">
                    ...
                    <div class="permit-field">
                        ...
                        >
                            ...
                            @foreach($jenisAktivitasLuar as $jenis)
                                ...
                                <option
                                    value="{{ $jenis->id }}"
                                    {{ old('id_jenis_aktivitas_luar') == $jenis->id ? 'selected' : '' }}
                                >
                    ...
                    <div class="permit-field">
                        ...
                        <textarea
                            ...
                            required
                        >{{ old('deskripsi_aktivitas_luar') }}</textarea>
                            ...
                            <div class="permit-field">
                                ...
                                <div class="permit-input-wrapper">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('tanggal_estimasi_kembali') }}"
                                        required
                                    >
                            ...
                            <div class="permit-field">
                                ...
                                <div class="permit-input-wrapper">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('waktu_estimasi_kembali') }}"
                                        required
                                    >
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        @if(session('permit_success'))
            ...
            Swal.fire({
                icon: 'success',
                title: 'Draft Permit Berhasil Disimpan',
        ...
        @if(session('permit_error'))

            Swal.fire({
                icon: 'error',
                title: 'Permit Gagal Disimpan',
                text: @json(session('permit_error')),
